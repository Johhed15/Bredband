...
I tätbyggda områden så har nästan alla hushåll tillgång till 5G i länets kommuner, men på glesbygden är det något lägre andelar, där Heby har den lägsta andelen på `r min_a[1]` procent och Uppsala kommun har näst lägst andel på `r min_a[2]` procent.
