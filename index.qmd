...
```{=html}
<div style="border:1px solid #ccc; background-color:#f9f9f9; padding:1rem 1.5rem; margin:1.5rem 0; border-radius:8px; max-width:100%; box-sizing:border-box;">
  <p style="margin:0.25rem 0; font-weight:bold;">Läget i Länet 2026 · Regional utveckling</p>
  <p style="margin:0.25rem 0; font-style:italic; color:#555;">Publicerad: mars 2026. Nästa uppdatering planeras till våren 2027.</p>
</div>
```
...
min_a <- round(sort(df$`Tillgång via NR (5G)`)[1:2]*100,1)


```
:::

I tätbyggda områden så har nästan alla hushåll tillgång till 5G i länets kommuner, men på glesbyggden är det något lägre andelar, där Heby har den lägsta andelen på `r min_a[1]` procent och Uppsala kommun har näst lägst andel på `r min_a[2]` procent.
